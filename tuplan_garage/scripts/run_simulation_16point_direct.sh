...
CHECKPOINT=/cephfs/zhanjh/PDM_EXP/EXP/exp/training_pdm_ref_16points_model/training_pdm_ref_16points_model/2024.09.01.22.43.49/best_model/epoch_100-step_128269.ckpt

python $NUPLAN_DEVKIT_ROOT/nuplan/planning/script/run_simulation.py \
+simulation=$CHALLENGE \
planner=pdm_hybrid_ref_16points_direct_planner \
...
experiment_uid=16point_direct_open_test \
