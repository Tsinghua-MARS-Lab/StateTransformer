...
from dataset_gen.preprocess import waymo_collate_func
...
def main():
    ...
    cfg_from_yaml_file("/home/ldr/workspace/transformer4planning/config/sample_config.yaml", cfg)
    ...
    if training_args.do_train:
        train_dataset = Dataset.load_from_disk(data_args.saved_dataset_folder)
        ...
        nuplan_dataset.update(train=train_dataset)
    ...
    if training_args.do_eval:
        ...
        test_dataset = test_dataset.shuffle(seed=training_args.seed)

        nuplan_dataset.update(validation=test_dataset)
    
    if training_args.do_predict:
        nuplan_dataset.update(test=test_dataset)
