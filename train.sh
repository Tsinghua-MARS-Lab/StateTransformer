...
python -m torch.distributed.run --nproc_per_node=6 --master_port=1235 runner.py \
        --model_name scratch-gpt-small --model_pretrain_name_or_path None \
        --saved_dataset_folder /localdata_ssd/liderun/t4p_waymo_cyc_scenario \
        ...
        --overwrite_output_dir --loss_fn mse --do_eval --evaluation_strategy steps --eval_steps 2000 --per_device_eval_batch_size 16 --max_eval_samples 20000 --agent_type 3
