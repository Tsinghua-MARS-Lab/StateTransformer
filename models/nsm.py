...
class NSMDecoder(nn.Module):
    ...
    def __init__(self, n_embed):
        ...
        # commented as currently only uses motion prediction model given weights
    ...
    def forward(self, hidden_states: Tensor, weight_blend: Tensor):
        """
        ...
        # TODO(cyrushx): Add gating input based on action labels and phase.
        ...
        output_embedding = self.comp_final(hidden_states, weight_blend.T)
        # TODO(cyrushx): Generate trajectories from output embedding.
        # [batch_size, d_embed]
