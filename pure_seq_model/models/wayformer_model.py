...
class WayformerModel(nn.Module):
    def __init__(self, config: Dict) -> None:
        ...
        encoder_cross_attn = base_model.CrossAttention(self.model_parameter.encoder_embedding_dim, self.model_parameter.encoder_head)
        ...
        encoder_latent_query_layer = base_model.TransformerDecoderLayer(self.model_parameter.encoder_embedding_dim, encoder_self_attn, encoder_cross_attn, encoder_p_ff)
    ...
    def normalize_input(self, input_dict):
        ...
        feature_tensor[..., [0, 1, 2, 3]] = feature_tensor[..., [0, 1, 2, 3]] / xy_norm_para
        feature_tensor[..., [7, 8]] = feature_tensor[..., [7, 8]] / vel_norm_para
        feature_tensor[..., [9, 10]] = feature_tensor[..., [9, 10]] / shape_norm_para
