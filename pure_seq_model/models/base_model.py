...
class SelfAttention(nn.Module):
    ...
    def forward(self, embed_states, attn_mask=None, key_padding_mask=None):
        embed_states, atten_weights = self.multi_head_attention(embed_states, embed_states, embed_states, attn_mask=attn_mask, key_padding_mask=key_padding_mask)
        return embed_states
...
class TransformerEncoderLayer(nn.Module):
    ...
    def forward(self, x, attn_mask=None, key_padding_mask=None):
        x = self.norm_self_attn(x + self.dropout_self_attn(self.self_attn(x, attn_mask=attn_mask, key_padding_mask=key_padding_mask)))
