...
python -m torch.distributed.run --nproc_per_node=7 runner_waymo.py \
        ...
        --output_dir /data_3/madanjiao/model_res/vector_gpt_small_k1_reverseKP5_ep100/training_results  \
        --logging_dir /data_3/madanjiao/model_res/vector_gpt_small_k1_reverseKP5_ep100/training_logs \
        ...
        --save_total_limit 2  --predict_trajectory True --ar_future_interval 5 --specified_key_points True\
