...
python -m torch.distributed.run --nproc_per_node=7 --master_port=29502 runner_waymo.py \
        ...
        --output_dir /localdata_ssd/liderun/tmp/vector_ipclr/training_results  \
        --logging_dir /localdata_ssd/liderun/tmp/vector_ipclr/training_logs \
        --run_name vector_ipclr --num_train_epochs 100 \
