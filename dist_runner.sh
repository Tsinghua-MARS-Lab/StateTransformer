...
python -m torch.distributed.run --nproc_per_node=7 --master_port=29502 runner_waymo.py \
        ...
        --logging_dir /data_3/madanjiao/model_res/vector_gpt_small_k6_forwardKP5_ep100/training_logs \
        ...
        --save_total_limit 50  --predict_trajectory True --ar_future_interval 5 --specified_key_points True --forward_specified_key_points True \
