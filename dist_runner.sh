...
python -m torch.distributed.run --nproc_per_node=7 runner_waymo.py \
        ...
        --output_dir /data_3/madanjiao/model_res/vector_gpt_small_k6_reverseKP5_masked_ep100_refactor/training_results  \
        --logging_dir /data_3/madanjiao/model_res/vector_gpt_small_k6_reverseKP5_masked_ep100_refactor/training_logs \
