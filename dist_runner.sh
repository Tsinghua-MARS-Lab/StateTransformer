...
python -m torch.distributed.run --nproc_per_node=8 runner_waymo.py \
        ...
        --output_dir /data_3/madanjiao/model_res/vector_gpt_small_ep100/training_results  \
        --logging_dir /data_3/madanjiao/model_res/vector_gpt_small_ep100/training_logs \
