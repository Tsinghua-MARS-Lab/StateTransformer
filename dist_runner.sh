...
python -m torch.distributed.run --nproc_per_node=7 --master_port=29502 runner_waymo.py \
        ...
        --output_dir /data_3/madanjiao/model_res/vector_gpt_small_k6_reverseKP5_correctA_excludeEgoep100/training_results  \
        --logging_dir /data_3/madanjiao/model_res/vector_gpt_small_k6_reverseKP5_correctA_excludeEgoep100/training_logs \
