...
python -m torch.distributed.run --nproc_per_node=7 runner_waymo.py \
        ...
        --output_dir /data_3/madanjiao/model_res/vector_gpt_small_k2_reverseKP5_masked_ep100_refactor_cls4/training_results  \
        --logging_dir /data_3/madanjiao/model_res/vector_gpt_small_k2_reverseKP5_masked_ep100_refactor_cls4/training_logs \
        ...
        --save_total_limit 50  --predict_trajectory True --ar_future_interval 5 --specified_key_points True\
        ...
        --task waymo --with_traffic_light True --k 2 \
