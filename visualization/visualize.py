    ...
    if target_split in root_folders and st.session_state.dataset == 'undefined':
        ...
        # for i, each_sample in enumerate(st.session_state.dataset):
            ...
            st.session_state.scenario_ids_by_file[file_name].append({
                ...
                'map': each_sample['map'] if 'map' in each_sample else 'unknown',
                'frame_id': int(each_sample['frame_id']),
                'scenario_type': each_sample['scenario_type'] if 'scenario_type' in each_sample else 'unknown',
                'route_ids': each_sample['route_ids'] if 'route_ids' in each_sample else [],
                'dataset_index': i
            })
