...
from transformer4planning.utils.logging_utils import get_validation_metrics_for_states
...
class DiffusionForcingBase(BasePytorchAlgo):
    ...
    # initialize the oprimizer for the diffusion transition model
    ...
    # norminalize the input data adn rearrange the data
