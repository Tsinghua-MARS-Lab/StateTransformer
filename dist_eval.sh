...
python -m torch.distributed.run --nproc_per_node=1 --master_port=29501 runner_waymo.py \
        ...
        --model_pretrain_name_or_path /data_3/madanjiao/model_res/vector_gpt_small_k2_reverseKP5_masked_ep100_refactor_cls4/training_results/checkpoint-25000 \
